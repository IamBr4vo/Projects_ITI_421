...
<div class="user-profile">
    <a href="/pages/users/settings.php"><span>Welcome</span><span class="text-orange"><?php echo $_SESSION['username']; ?></span>
...
<div class="card-body">
    <form action="/actions/rides/addRide.php" method="post">
        ...
        <div class="mt-3">
            ...
            <textarea class="form-control" id="description" name="description" rows="2" placeholder="Add here the description of the ride" required></textarea>
        </div>
        <hr>
