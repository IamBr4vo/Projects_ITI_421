...
require($_SERVER['DOCUMENT_ROOT'] . '/models/getSettingsData.php');
?>
...
<div class="card-body">
    ...
    <form id="settingsForm" action="/actions/users/updateSettingsData.php" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="speedAverage" name="speedAverage" value="<?= htmlspecialchars($user_settings['speed_average']) ?>">
        </div>
        <div class="mb-3">
            <label for="description" class="form-label">About Me</label>
            <textarea class="form-control" id="description" name="description" rows="2" placeholder="Something about me goes here"><?= htmlspecialchars($user_settings['description']) ?></textarea>
        </div>
        <div>
