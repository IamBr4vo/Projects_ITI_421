...
<div class="card mt-2">
    ...
    <div class="card-body">
                    ...
                    <?php foreach ($rides as $ride) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/pages/rides/editRides.php?rideId=<?php echo $ride['id']; ?>" class="btn btn-primary">Edit</a>
                                <!-- Add delete functionality -->
                                <a href="/actions/rides/deleteRide.php?rideId=<?php echo $ride['id']; ?>" class="btn btn-danger" onclick="confirmDelete()">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <div class="text-end mt-3">
            <a href="/pages/rides/addRides.php" class="btn btn-success">Add</a>
        </div>
    </div>
</div>